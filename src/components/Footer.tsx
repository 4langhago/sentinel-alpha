        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-white font-bold text-lg">시세 인사이트</span>
            </div>
            <p className="text-sm leading-relaxed mb-4 max-w-xs">
              국토교통부 실거래가 기반 부동산 시세 분석. 실제 거래된 가격으로 아파트·오피스텔 시세와
              평당가 추이를 확인하세요.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/search" className="hover:text-white transition-colors flex items-center space-x-1"><Search className="w-3 h-3" /><span>실거래 검색</span></Link></li>
              ...
              <li><Link to="/favorites" className="hover:text-white transition-colors flex items-center space-x-1"><Heart className="w-3 h-3" /><span>관심 단지</span></Link></li>
            </ul>
          </div>
